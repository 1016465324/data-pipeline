...
public class Message14 extends Message13 {
    public Message14(String version, ProtocolType type, String schemaNs, int batchNo) {
        super(version, type, schemaNs, batchNo);
        this.schema = new Schema14(schemaNs, batchNo);
    }

    public Message14(String version, ProtocolType type, String schemaNs, int batchNo, List<Field> unsetField) {
        super(version, type, schemaNs, batchNo);
